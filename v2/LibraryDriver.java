...
public class LibraryDriver {
    ...
    private static final String FILE_NAME = "library_v2.ser";

    // Serialization of the library to a file

    public static void serialize(Library library) throws IOException {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(FILE_NAME))) {
            oos.writeObject(library);
            System.out.println("\n[VERS2] The library has been serialized into a file: " + FILE_NAME);
        }
    }

    // Deserialization of the library from a file
    ...
    public static Library deserialize() throws IOException, ClassNotFoundException {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(FILE_NAME))) {
            ...
            System.out.println("[VERS2] The library has been deserialized from a file: " + FILE_NAME);
            return library;
        }
    }

    public static void main(String[] args) {
        System.out.println(" VERSION 2: Author/Book/Reader - NOT Serializable, transient ");
        ...
        try {
            ...
            // Returning a book (in the restored system)

            System.out.println(" Returning a book ");
            Reader restoredTest2 = restored.getReaders().get(1);
            Book   restoredBook3 = restoredTest2.getBorrowedBooks().get(0);
            restored.returnBook(restoredTest2, restoredBook3);
