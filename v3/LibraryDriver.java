...
public class LibraryDriver {
    ...
    private static final String FILE_NAME = "library_v3.ext";
    ...
    public static void serialize(Library library) throws IOException {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(FILE_NAME))) {
            ...
            System.out.println("\n[VERS3] The library has been serialized into a file: " + FILE_NAME);
        }
    }
    ...
    public static Library deserialize() throws IOException, ClassNotFoundException {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(FILE_NAME))) {
            ...
            System.out.println("[VERS3] The library has been deserialized from a file: " + FILE_NAME);
            return library;
        }
    }

    public static void main(String[] args) {
        System.out.println(" VERSION 3: All classes implement Externalizable ");
        ...
        try {
            ...
            Reader restoredTest3 = restored.getReaders().get(2);
            Book   restoredBook2 = restoredTest3.getBorrowedBooks().get(0);
            restored.returnBook(restoredTest3, restoredBook2);
